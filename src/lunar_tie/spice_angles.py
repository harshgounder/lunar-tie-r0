...
SPICE_DIR = "/home/liebert511/chandrayaan-2-data"
CK_DIR = "/home/liebert511/Downloads/ABDM"
...
def angles_for_product(utc_obs, naif_id="-152", frame_id=-152001):
    ...
    cmat, sclk_out = sp.ckgp(frame_id, sclk, 7200.0, "J2000")
    st, _ = sp.spkezr(naif_id, et, "J2000", "NONE", "301")
    sun_moon, _ = sp.spkezr("SUN", et, "J2000", "LT+S", "301")

    # boresight = the Z axis of the instrument frame rotated to J2000
    z_body = [cmat[0][2], cmat[1][2], cmat[2][2]]
    inc_rad = sp.vsep(z_body, sun_moon[:3])
...
if __name__ == "__main__":
    ...
    a = angles_for_product("2024-03-30 00:35:08.536")
    ...
    b = angles_for_product("2024-05-23 16:00:30.958")
